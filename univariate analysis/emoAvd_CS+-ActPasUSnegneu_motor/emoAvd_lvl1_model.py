...
for run_dir in run_list:
    ...
    # subj_df_original = pd.read_table('/Users/chendanlei/Dropbox (Partners HealthCare)/U01/EmotionAvoidanceTask/BIDS_BehavioralData/sub-014/sub-014_task-emo3_run-01_events.tsv', sep='\t')
