...
setenv PROJNAME emoAvd_CS+-ActPasUSnegneu_motor
...
rsync -ra $DATA/BIDS_fmriprep/fmriprep/ses-02/$SUBJ/func/*emo3_run-* /scratch/$USER/$SUBJ/$PROJNAME/BIDS_preproc/$SUBJ/func
...
# rsync -r /scratch/$USER/$SUBJ/$PROJNAME/BIDS_modeled/ /autofs/cluster/iaslab/FSMAP2/FSMAP_data/BIDS_modeled/
